...
export default function EventCard({
  ...
  if (variant === "list") {
    return (
      <Card
        className={`group cursor-pointer py-0 transition-all hover:border-purple-500/50 hover:shadow-lg ${className}`}
        onClick={onClick}
      >
        <CardContent className="flex gap-3 p-3">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="mb-1 line-clamp-2 text-sm font-semibold transition-colors group-hover:text-purple-400">
              {event.title}
            </h3>
    ...
    >
      ...
      <CardContent className="space-y-3">
        <div>
          ...
          <h3 className="line-clamp-2 text-lg font-semibold transition-colors group-hover:text-purple-400">
            {event.title}
          </h3>
        </div>
