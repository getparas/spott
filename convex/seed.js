...
// Sample events data with Nepal locations
const SAMPLE_EVENTS = [
  {
...
Light refreshments will be provided. Limited seats available.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Kathmandu+Valley+Tech+Hub",
...
Pizza and drinks provided!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Patan+Digital+Hub",
  ...
  },
  {
    ...
    description: `An evening of soulful acoustic performances by indie artists from across Nepal!
...
Food and beverages available for purchase at the venue.`,
    ...
    city: "Bhaktapur",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Bhaktapur+Heritage+Cafe",
...
Continental breakfast included in registration.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Jhamsikhel+Business+District",
  ...
  },
  {
    ...
    description: `Capture the vibrant streets of Kathmandu through your lens!

Join our photography walk covering:
- Thamel's bustling markets
- Hidden architectural gems
- Street culture and portraits
...
Chai stops included along the way!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Pashupatinath+Temple",
...
Laptop required. Course materials provided.`,
    ...
    city: "Pokhara",
    state: "Gandaki",
    venue: "https://maps.google.com/?q=Pokhara+Tech+Center",
...
Referee provided. Water and energy drinks available. Medical support on standby.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Dashrath+Stadium",
    address: "Dashrath Rangasala, Tripureshwor, Kathmandu, Nepal",
    capacity: 56,
    ticketType: "paid",
    ticketPrice: 350,
    coverImage:
...
Taste everything you cook! Great for health enthusiasts and curious foodies alike.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Community+Kitchen+Kathmandu",
...
Yoga mats provided. Please wear comfortable clothing.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Shivapuri+Yoga+Studio",
...
Energy drinks and snacks available. Exciting commentary and crowd interaction!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Gaming+Arena+Thamel",
    address: "Thamel, Kathmandu, Nepal",
    capacity: 80,
    ticketType: "paid",
    ticketPrice: 200,
...
- Engineering managers from leading tech companies
...
Open to all genders. Q&A session and networking lunch included.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=TechHub+Kathmandu",
    address: "Bhat Bhateni, Kathmandu, Nepal",
    capacity: 40,
    ticketType: "free",
    coverImage:
  ...
  {
    title: "Trekking to Chandragiri Hills - Weekend Adventure",
    description: `Experience the majestic Himalayan views on this beginner-friendly trek!

Itinerary:
- Day 1: Kathmandu to Chandragiri (8km trek)
- Overnight camping with valley views
...
Transport from Kathmandu available at additional cost.`,
    category: "outdoor",
    tags: ["outdoor", "trekking", "adventure", "camping"],
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Chandragiri+Hills",
    address: "Chandragiri, Kathmandu, Nepal",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2500,
    coverImage:
  ...
  {
    title: "Community Clean-up Drive - River Bank Edition",
    description: `Join hands to keep our rivers and surroundings clean and beautiful!

Activity plan:
- River bank cleanup (2 hours)
- Waste segregation workshop
- Environmental conservation talk
- Group photo session
...
Refreshments provided. A great way to give back to nature while meeting like-minded people!`,
    category: "community",
    tags: ["community", "environment", "volunteer", "conservation"],
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Bagmati+River+Park",
    address: "Bagmati River Bank, Kathmandu, Nepal",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Code examples and cheat sheets provided.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Dev+Academy+Nepal",
...
Sleeping bags welcome. Food and drinks provided throughout.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Innovation+Hub+Nepal",
...
Lunch and refreshments included. Bring your laptop!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Startup+Hub+Kathmandu",
...
Continental breakfast and unlimited coffee included!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Coworking+Space+Kathmandu",
    address: "Patan, Lalitpur, Nepal",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 399,
...
- Finding compelling stories in Kathmandu
- Composition techniques
- Candid vs posed shots
- Photo walk in heritage areas
...
Snacks and beverages provided both days.`,
    ...
    city: "Bhaktapur",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Photography+Studio+Bhaktapur",
    address: "Durbar Square Area, Bhaktapur, Nepal",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2499,
    coverImage:
  ...
  },
  {
    ...
    description: `The biggest corporate cricket showdown in Nepal is back!
...
Perfect for team building and corporate bonding!`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Nepal+Cricket+Ground",
...
Healthy snacks and herbal teas included.`,
    ...
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Wellness+Center+Kathmandu",
  ...
  {
    title: "Momo & Food Fest: A Taste of Nepal",
    description: `Join us for an evening of traditional Nepali food making and tasting! Learn the secrets to crafting authentic momos and explore a variety of delicious Nepali cuisines. You'll leave with new skills and a full stomach.`,
    category: "food",
    tags: ["food", "nepali-cuisine", "cooking"],
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Heritage+Food+Studio+Kathmandu",
    address: "Thamel, Kathmandu, Nepal",
    capacity: 10,
    ticketType: "free",
    coverImage:
      "https://images.unsplash.com/photo-1513104890138-7c749659a591?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NjkyNzJ8MHwxfHNlYXJjaHwxfHxmb29kfGVufDB8fHx8fDE3NjI5NTA5NTh8MA&ixlib=rb-4.1.0&q=80&w=1080",
    themeColor: "#831843",
  },
  {
    ...
    category: "tech",
    tags: ["tech", "react", "next.js", "web-development"],
    city: "Kathmandu",
    state: "Bagmati",
    venue: "https://maps.google.com/?q=Tech+Campus+Kathmandu",
    address: "Jawalakhel, Lalitpur, Nepal",
    capacity: 75,
    ticketType: "paid",
    ticketPrice: 250,
